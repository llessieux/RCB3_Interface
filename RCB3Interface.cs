...
public class RCB3Interface
{
    ...
    /////////////////////////
    [DllImport("RCB3_Interface.dll")] 
    public static extern bool SendBytesToCOMPort(uint in_rcb3,byte[] in_buffer,uint in_buffer_size);

    [DllImport("RCB3_Interface.dll")] 
    public static extern bool ReceiveBytesFromCOMPort(uint in_rcb3,byte[] out_buffer,uint in_buffer_size);
