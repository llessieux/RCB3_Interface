...
Public Class Rcb3
    ...
    Public Declare Function GetLastRCB3ErrorName Lib "RCB3_Interface.dll" Alias "GetLastRCB3ErrorName" (ByVal myerror As UInteger) As String
    Public Declare Function GetLastRCB3FullErrorMessage Lib "RCB3_Interface.dll" Alias "GetLastRCB3FullErrorMessage" () As String
